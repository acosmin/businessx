...
/* ------------------------------------------------------------------------- */
?>
<article <?php post_class(); ?> title="<?php printf( esc_html__( 'Blog post: %s', 'businessx' ), get_the_title() ); ?>">
	<?php if( has_post_thumbnail( get_the_ID() ) ) { ?>
    <figure class="entry-thumbnail">
    	<a href="<?php echo esc_url( get_permalink() ); ?>" rel="nofollow"><?php echo get_the_post_thumbnail( get_the_ID(), apply_filters( 'businessx_blog_index___thumbnail_size', 'bx-blog-normal' ) ); ?></a>
